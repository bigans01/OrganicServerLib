...
public:
	OSContouredTriangle();
	OSContouredTriangle(ECBPolyPoint in_point0, 
	...
	PerfectClampEnum getPerfectClampValue();
private:
	...
	PerfectClampEnum contouredTrianglePerfectClampValue = PerfectClampEnum::NONE;	// 0 if there is no clamping; 1 if clamped to X, 2 if clamped to Y, 3 if clamped to Z.
